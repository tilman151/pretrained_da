...
def run(source, target, percent_broken, domain_tradeoff, cap, record_embeddings, seed, gpu):
...
def run_multiple(source, target, broken, domain_tradeoff, cap, record_embeddings, replications, gpu):
...
if __name__ == '__main__':
    ...
    run_multiple(opt.source, opt.target, opt.broken, opt.domain_tradeoff,
                 opt.cap, opt.record_embeddings, opt.replications, opt.gpu)
